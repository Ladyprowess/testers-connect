...
export default async function HomePage() {
  ...
  const offers: OfferItem[] = [
    {
      title: "Events",
      desc: "Online and in-person sessions that help you grow.",
      href: "/events",
    ...
    {
      title: "Blog",
      desc: "Clear articles written by testers for career growth.",
      href: "/blog",
      metric: "From 20+ Countries",
      Icon: Book,
      bg: "bg-[#16A34A]",
    },
    {
    ...
    {
      title: "Community",
      desc: "Connect with testers worldwide and grow.",
      href: "/community",
      metric: "1K+ Members",
      Icon: Users,
      bg: "bg-[#7C3AED]",
